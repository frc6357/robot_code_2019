...
public class BaseAngledControlledArm extends BaseMotorizedArm {
     ...
     *                       distance
     *
     * @param armLimitTop    - Type: int - DIO for upper limit sensor
     */
    public BaseAngledControlledArm(SpeedController armRotateMotor, Encoder armEncoder, BaseLimitSensor armLimitTop) {
        super(armRotateMotor, armLimitTop);
     ...
     *                       distance
     *
     * @param armLimitBottom - Type: int - DIO for bottom limit sensor
     */
    public BaseAngledControlledArm(SpeedController armRotateMotor, Encoder armEncoder, BaseLimitSensor armLimitBottom)
    {
        super(armRotateMotor, armLimitBottom);
